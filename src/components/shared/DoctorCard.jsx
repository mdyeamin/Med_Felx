  ...
  return (
    ...
    >
      <Card className="bg-white dark:bg-[#0f172a] border  p-0 border-gray-100 dark:border-slate-800/80 rounded-xl overflow-hidden shadow-sm flex flex-col justify-between h-full hover:shadow-md transition-all duration-300">
        ...
        <div className="px-5 pb-5 pt-1  gap-3 items-center border-t border-gray-100/50 dark:border-slate-800/40 mt-auto">
          <Link href={`all-appointments/${_id}`}>
          <Button className="w-full h-11 bg-[#006A9C] dark:bg-[#0EA5E9] text-white dark:text-slate-900 font-bold text-xs rounded-md shadow-[0_4px_12px_rgba(0,106,156,0.15)] dark:shadow-[0_4px_12px_rgba(14,165,233,0.2)] transition-all duration-200 hover:bg-[#005B84] dark:hover:bg-[#38bdf8]">
            Book Appointment
          </Button>
          </Link>
